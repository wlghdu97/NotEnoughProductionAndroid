...
-keepclassmembers @kotlinx.serialization.Serializable class com.xhlab.nep.** {
...
# lookup for plugin generated serializable classes
-if @kotlinx.serialization.Serializable class com.xhlab.nep.**
-keepclassmembers class com.xhlab.nep.<1>$Companion {
    kotlinx.serialization.KSerializer serializer(...);
}
...
-keep class com.xhlab.nep.shared.parser.process.**$$serializer {
    *** INSTANCE;
}
